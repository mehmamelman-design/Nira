...
export const ItemCustomizerModal: React.FC<ItemCustomizerModalProps> = ({
  ...
  // Calculation Logic:
  // Yekun Qiymət = ( Əsas Qiymət + Ölçü Fərqi + Əlavə Sousların Qiyməti ) * Miqdar (Quantity)
  ...
  }, [item.price, selectedSize.extraPrice, saucesTotalPrice]);
  ...
  const handleAdd = () => {
    ...
    const optionSummary = optionParts.join(' | ');
